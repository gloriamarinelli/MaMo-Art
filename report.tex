...
\begin{itemize}
      ...
      \item \textbf{/addtocart} (GET):
      \item \textbf{/getArtists} (GET):
      \item \textbf{/getPaintingsArtistCollection} (GET):
      \item \textbf{/getBio} (GET):
      \item \textbf{/getUserOrders} (GET):
